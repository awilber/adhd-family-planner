...
import { ConsoleLogger as Logger, Hub, urlSafeEncode, USER_AGENT_HEADER, } from '@aws-amplify/core';
...
var OAuth = /** @class */ (function () {
    ...
    OAuth.prototype._handleCodeFlow = function (currentUrl, userAgentValue) {
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, fetch(oAuthTokenEndpoint, {
                                ...
                                headers: (_b = {
                                    ...
                                    _b[USER_AGENT_HEADER] = userAgentValue,
                                    _b),
                                body: body,
                            })];
    ...
    OAuth.prototype.handleAuthResponse = function (currentUrl, userAgentValue) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = [{}];
                        return [4 /*yield*/, this._handleCodeFlow(currentUrl, userAgentValue)];
