...
import { Amplify, AuthAction, ConsoleLogger as Logger, Credentials, getAmplifyUserAgent, Hub, StorageHelper, Platform, browserOrNode, parseAWSExports, UniversalStorage, urlSafeDecode, } from '@aws-amplify/core';
import { CookieStorage, AuthenticationDetails, CognitoUserSession, CognitoUserAttribute, CognitoIdToken, CognitoRefreshToken, CognitoAccessToken, } from 'amazon-cognito-identity-js';
import { addAuthCategoryToCognitoUserAgent, addFrameworkToCognitoUserAgent, InternalCognitoUser, InternalCognitoUserPool, } from 'amazon-cognito-identity-js/internals';
...
var InternalAuthClass = /** @class */ (function () {
    ...
    InternalAuthClass.prototype.configure = function (config) {
        ...
        if (userPoolId) {
            ...
            this.userPool = new InternalCognitoUserPool(userPoolData, this.wrapRefreshSessionCallback);
        }
    ...
    InternalAuthClass.prototype.signUp = function (params, restOfAttrs, customUserAgentDetails) {
        ...
        return new Promise(function (resolve, reject) {
            var userAgentDetails = getAuthUserAgentDetails(AuthAction.SignUp, customUserAgentDetails);
            ...
            }, clientMetadata, getAmplifyUserAgent(userAgentDetails));
        });
    };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, user.authenticateUser(authDetails, this.authCallbacks(user, function (value) {
                                ...
                                logger.error(error);
                                _this._storage.removeItem('amplify-auto-sign-in');
                            }, customUserAgentDetails), getAmplifyUserAgent(customUserAgentDetails))];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    InternalAuthClass.prototype.confirmSignUp = function (username, code, options, customUserAgentDetails) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            }, clientMetadata, getAuthUserAgentValue(AuthAction.ConfirmSignUp, customUserAgentDetails));
        });
    };
    ...
    InternalAuthClass.prototype.resendSignUp = function (username, clientMetadata, customUserAgentDetails) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            }, clientMetadata, getAuthUserAgentValue(AuthAction.ResendSignUp, customUserAgentDetails));
        });
    };
    /**
     * Sign in
    ...
    InternalAuthClass.prototype.signIn = function (usernameOrSignInOpts, pw, clientMetadata, customUserAgentDetails) {
        ...
        var userAgentDetails = getAuthUserAgentDetails(AuthAction.SignIn, customUserAgentDetails);
        if (password) {
    ...
    InternalAuthClass.prototype.signInWithoutPassword = function (authDetails, customUserAgentDetails) {
        ...
        return new Promise(function (resolve, reject) {
            user.initiateAuth(authDetails, _this.authCallbacks(user, resolve, reject, customUserAgentDetails), getAmplifyUserAgent(customUserAgentDetails));
        });
    };
    /**
    ...
    InternalAuthClass.prototype.getPreferredMFA = function (user, params, customUserAgentDetails) {
        ...
        return new Promise(function (res, rej) {
            ...
            var userAgentValue = getAuthUserAgentValue(AuthAction.GetPreferredMFA, customUserAgentDetails);
            internalUser.getUserData(function (err, data) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        internalUser = user;
                        userAgentValue = getAuthUserAgentValue(AuthAction.SetPreferredMFA, customUserAgentDetails);
                        clientMetadata = this._config.clientMetadata;
    ...
    InternalAuthClass.prototype.verifyTotpToken = function (user, challengeAnswer, customUserAgentDetails) {
        ...
        return new Promise(function (res, rej) {
            ...
            }, getAuthUserAgentValue(AuthAction.VerifyTotpToken, customUserAgentDetails));
        });
    };
    /**
    ...
    InternalAuthClass.prototype.confirmSignIn = function (user, code, mfaType, clientMetadata, customUserAgentDetails) {
        ...
        var that = this;
        var userAgentDetails = getAuthUserAgentDetails(AuthAction.ConfirmSignIn, customUserAgentDetails);
        return new Promise(function (resolve, reject) {
            ...
            }, mfaType, clientMetadata, getAmplifyUserAgent(userAgentDetails));
        });
    };
    InternalAuthClass.prototype.completeNewPassword = function (user, password, requiredAttributes, clientMetadata, customUserAgentDetails) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            }, clientMetadata, getAuthUserAgentValue(AuthAction.CompleteNewPassword, customUserAgentDetails));
        });
    };
    /**
    ...
    InternalAuthClass.prototype.sendCustomChallengeAnswer = function (user, challengeResponses, clientMetadata, customUserAgentDetails) {
        ...
        var that = this;
        var userAgentDetails = getAuthUserAgentDetails(AuthAction.SendCustomChallengeAnswer, customUserAgentDetails);
        return new Promise(function (resolve, reject) {
            internalUser.sendCustomChallengeAnswer(challengeResponses, _this.authCallbacks(internalUser, resolve, reject, userAgentDetails), clientMetadata, getAmplifyUserAgent(userAgentDetails));
        });
    };
    /**
    ...
    InternalAuthClass.prototype.deleteUserAttributes = function (user, attributeNames, customUserAgentDetails) {
        var internalUser = user;
        var that = this;
        var userAgentValue = getAuthUserAgentValue(AuthAction.DeleteUserAttributes, customUserAgentDetails);
        return new Promise(function (resolve, reject) {
                                ...
                                return __generator(this, function (_a) {
                                    if (this.userPool) {
                                        ...
                                        if (!internalUser_1) {
                                            ...
                                            userAgentValue_1 = getAuthUserAgentValue(AuthAction.DeleteUser, customUserAgentDetails);
                                            internalUser_1.getSession(function (err, session) { return __awaiter(_this, void 0, void 0, function () {
                                                var cleanUpError_4;
                                                var _this = this;
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
    ...
    InternalAuthClass.prototype.updateUserAttributes = function (user, attributes, clientMetadata, customUserAgentDetails) {
        ...
        var attributeList = [];
        var that = this;
        var userAgentValue = getAuthUserAgentValue(AuthAction.UpdateUserAttributes, customUserAgentDetails);
        return new Promise(function (resolve, reject) {
            that._userSession(userAgentValue, internalUser).then(function (session) {
    ...
    InternalAuthClass.prototype._userAttributes = function (user, customUserAgentDetails) {
        var _this = this;
        var internalUser = user;
        var userAgentValue = getAuthUserAgentValue(AuthAction.UserAttributes, customUserAgentDetails);
        return new Promise(function (resolve, reject) {
    ...
    InternalAuthClass.prototype.verifiedContact = function (user, customUserAgentDetails) {
        var that = this;
        return this._userAttributes(user, getAuthUserAgentDetails(AuthAction.VerifiedContact, customUserAgentDetails)).then(function (attributes) {
            ...
            _this._storageSync
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            _b.trys.push([3, 7, , 8]);
                            userAgentValue_2 = getAuthUserAgentValue(AuthAction.CurrentUserPoolUser, customUserAgentDetails);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        _a.trys.push([6, 8, , 9]);
                        return [4 /*yield*/, this._currentUserPoolUser(params, getAuthUserAgentDetails(AuthAction.CurrentAuthenticatedUser, customUserAgentDetails))];
                    case 7:
                        user = _a.sent();
                        return [3 /*break*/, 9];
                    case 8:
    ...
    InternalAuthClass.prototype._currentSession = function (customUserAgentDetails) {
        var that = this;
        var userAgentDetails = getAuthUserAgentDetails(AuthAction.CurrentSession, customUserAgentDetails);
                    ...
                    case 0:
                        ...
                        if (this.inflightSessionPromiseCounter === 0) {
                            this.inflightSessionPromise = new Promise(function (res, rej) {
                                internalUser.getSession(function (err, session) { return __awaiter(_this, void 0, void 0, function () {
                                    var cleanUpError_6;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
    ...
    InternalAuthClass.prototype.userSession = function (user, customUserAgentDetails) {
        return this._userSession(getAuthUserAgentValue(AuthAction.UserSession, customUserAgentDetails), user);
    };
    /**
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (federatedInfo) {
                            ...
                            return [2 /*return*/, this._currentSession(getAuthUserAgentDetails(AuthAction.CurrentUserCredentials, customUserAgentDetails))
                                    .then(function (session) {
    ...
    InternalAuthClass.prototype._verifyUserAttribute = function (user, attr, clientMetadata, customUserAgentDetails) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            }, clientMetadata, getAuthUserAgentValue(AuthAction.VerifyUserAttribute, customUserAgentDetails));
        });
    };
    /**
    ...
    InternalAuthClass.prototype._verifyUserAttributeSubmit = function (user, attr, code, customUserAgentDetails) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            }, getAuthUserAgentValue(AuthAction.VerifyUserAttributeSubmit, customUserAgentDetails));
        });
    };
    InternalAuthClass.prototype.verifyCurrentUserAttribute = function (attr, customUserAgentDetails) {
        var userAgentDetails = getAuthUserAgentDetails(AuthAction.VerifyCurrentUserAttribute, customUserAgentDetails);
        var that = this;
        return that
            ._currentUserPoolUser(undefined, userAgentDetails)
            .then(function (user) {
    ...
    InternalAuthClass.prototype.verifyCurrentUserAttributeSubmit = function (attr, code, customUserAgentDetails) {
        var userAgentDetails = getAuthUserAgentDetails(AuthAction.VerifyCurrentUserAttributeSubmit, customUserAgentDetails);
        var that = this;
        return that
            ._currentUserPoolUser(undefined, userAgentDetails)
            .then(function (user) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, new Promise(function (res, rej) {
                                if (opts && opts.global) {
                                    ...
                                    var clientMetadata = _this._config.clientMetadata; // TODO: verify behavior if this is override during signIn
                                    internalUser.getSession(function (err, result) { return __awaiter(_this, void 0, void 0, function () {
                                        var cleanUpError_7;
                                        var _this = this;
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.cognitoIdentitySignOut(opts, internalUser, getAuthUserAgentValue(AuthAction.SignOut, customUserAgentDetails))];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
    ...
    InternalAuthClass.prototype.changePassword = function (user, oldPassword, newPassword, clientMetadata, customUserAgentDetails) {
        ...
        if (clientMetadata === void 0) { clientMetadata = this._config.clientMetadata; }
        var internalUser = user;
        var userAgentValue = getAuthUserAgentValue(AuthAction.ChangePassword, customUserAgentDetails);
        return new Promise(function (resolve, reject) {
            _this._userSession(userAgentValue, internalUser).then(function (session) {
    ...
    InternalAuthClass.prototype.forgotPassword = function (username, clientMetadata, customUserAgentDetails) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            }, clientMetadata, getAuthUserAgentValue(AuthAction.ForgotPassword, customUserAgentDetails));
        });
    };
    /**
    ...
    InternalAuthClass.prototype.forgotPasswordSubmit = function (username, code, password, clientMetadata, customUserAgentDetails) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            }, clientMetadata, getAuthUserAgentValue(AuthAction.ForgotPasswordSubmit, customUserAgentDetails));
        });
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        userAgentDetails = getAuthUserAgentDetails(AuthAction.CurrentUserInfo, customUserAgentDetails);
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (this._config.userPoolId) {
                            ...
                            this._storage.setItem('aws-amplify-federatedUserAgent', getAuthUserAgentValue(AuthAction.FederatedSignIn, customUserAgentDetails));
    ...
    InternalAuthClass.prototype.createCognitoUser = function (username) {
        ...
        var internalUser = new InternalCognitoUser(userData);
    ...
    InternalAuthClass.prototype.rememberDevice = function (customUserAgentDetails) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userAgentDetails = getAuthUserAgentDetails(AuthAction.RememberDevice, customUserAgentDetails);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._currentUserPoolUser(undefined, userAgentDetails)];
    ...
    InternalAuthClass.prototype.forgetDevice = function (customUserAgentDetails) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userAgentDetails = getAuthUserAgentDetails(AuthAction.ForgetDevice, customUserAgentDetails);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._currentUserPoolUser(undefined, userAgentDetails)];
    ...
    InternalAuthClass.prototype.fetchDevices = function (customUserAgentDetails) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userAgentDetails = getAuthUserAgentDetails(AuthAction.FetchDevices, customUserAgentDetails);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._currentUserPoolUser(undefined, userAgentDetails)];
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, new Promise(function (res, rej) {
                                ...
                                internalUser.listDevices(MAX_DEVICES, null, cb, getAmplifyUserAgent(userAgentDetails));
                            })];
                }
            });
        });
...
export { InternalAuthClass };
export var InternalAuth = new InternalAuthClass(null);
