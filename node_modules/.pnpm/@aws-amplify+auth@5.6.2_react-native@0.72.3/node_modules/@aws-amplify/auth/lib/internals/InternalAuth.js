 ...
 */
var InternalAuthClass = /** @class */ (function () {
    /**
     * Initialize Auth with AWS configurations
     * @param {Object} config - Configuration of the Auth
     */
    function InternalAuthClass(config) {
        var _this = this;
        this.userPool = null;
        this.user = null;
    ...
    InternalAuthClass.prototype.getModuleName = function () {
        return 'InternalAuth';
    };
    InternalAuthClass.prototype.configure = function (config) {
        var _this = this;
        if (!config)
            return this._config || {};
        ...
        if (userPoolId) {
            ...
            this.userPool = new internals_1.InternalCognitoUserPool(userPoolData, this.wrapRefreshSessionCallback);
        }
    ...
    InternalAuthClass.prototype.signUp = function (params, restOfAttrs, customUserAgentDetails) {
        var _this = this;
        var _a, _b, _c;
        if (!this.userPool) {
        ...
        return new Promise(function (resolve, reject) {
            var userAgentDetails = utils_1.getAuthUserAgentDetails(core_1.AuthAction.SignUp, customUserAgentDetails);
            _this.userPool.signUp(username, password, attributes, validationData, function (err, data) {
                if (err) {
                    ...
                    if (autoSignIn.enabled) {
                        _this.handleAutoSignIn(username, password, autoSignInValidationData, autoSignInClientMetaData, data, userAgentDetails);
                    }
                    resolve(data);
                }
            }, clientMetadata, core_1.getAmplifyUserAgent(userAgentDetails));
        });
    };
    InternalAuthClass.prototype.handleAutoSignIn = function (username, password, validationData, clientMetadata, data, customUserAgentDetails) {
    ...
    InternalAuthClass.prototype.handleCodeAutoSignIn = function (authDetails, customUserAgentDetails) {
        var _this = this;
        var listenEvent = function (_a) {
            var payload = _a.payload;
            if (payload.event === 'confirmSignUp') {
                _this.signInAfterUserConfirmed(authDetails, customUserAgentDetails, listenEvent);
            }
        };
        core_1.Hub.listen('auth', listenEvent);
    };
    InternalAuthClass.prototype.handleLinkAutoSignIn = function (authDetails, customUserAgentDetails) {
        var _this = this;
        ...
        var autoSignInPollingIntervalId = setInterval(function () {
            if (Date.now() - start > MAX_AUTOSIGNIN_POLLING_MS) {
                ...
                _this.signInAfterUserConfirmed(authDetails, customUserAgentDetails, undefined, autoSignInPollingIntervalId);
            }
        }, 5000);
    };
    InternalAuthClass.prototype.signInAfterUserConfirmed = function (authDetails, customUserAgentDetails, listenEvent, autoSignInPollingIntervalId) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, user.authenticateUser(authDetails, this.authCallbacks(user, function (value) {
                                ...
                                logger.error(error);
                                _this._storage.removeItem('amplify-auto-sign-in');
                            }, customUserAgentDetails), core_1.getAmplifyUserAgent(customUserAgentDetails))];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
     ...
     */
    InternalAuthClass.prototype.confirmSignUp = function (username, code, options, customUserAgentDetails) {
        var _this = this;
        if (!this.userPool) {
            return this.rejectNoUserPool();
        }
        ...
        return new Promise(function (resolve, reject) {
            ...
            }, clientMetadata, utils_1.getAuthUserAgentValue(core_1.AuthAction.ConfirmSignUp, customUserAgentDetails));
        });
    };
    InternalAuthClass.prototype.isTrueStorageValue = function (value) {
     ...
     */
    InternalAuthClass.prototype.resendSignUp = function (username, clientMetadata, customUserAgentDetails) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            }, clientMetadata, utils_1.getAuthUserAgentValue(core_1.AuthAction.ResendSignUp, customUserAgentDetails));
        });
    };
    /**
     * Sign in
     ...
     */
    InternalAuthClass.prototype.signIn = function (usernameOrSignInOpts, pw, clientMetadata, customUserAgentDetails) {
        if (clientMetadata === void 0) { clientMetadata = this._config.clientMetadata; }
        if (!this.userPool) {
            return this.rejectNoUserPool();
        }
        ...
        var userAgentDetails = utils_1.getAuthUserAgentDetails(core_1.AuthAction.SignIn, customUserAgentDetails);
        if (password) {
     ...
     */
    InternalAuthClass.prototype.authCallbacks = function (user, resolve, reject, customUserAgentDetails) {
        var _this = this;
        var that = this;
        return {
            onSuccess: function (session) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            _a.trys.push([5, 7, , 8]);
                            return [4 /*yield*/, this._currentUserPoolUser(undefined, customUserAgentDetails)];
                        case 6:
                            currentUser = _a.sent();
     ...
     */
    InternalAuthClass.prototype.signInWithPassword = function (authDetails, customUserAgentDetails) {
        var _this = this;
     ...
     */
    InternalAuthClass.prototype.signInWithoutPassword = function (authDetails, customUserAgentDetails) {
        var _this = this;
        var user = this.createCognitoUser(authDetails.getUsername());
        user.setAuthenticationFlowType('CUSTOM_AUTH');
        return new Promise(function (resolve, reject) {
            user.initiateAuth(authDetails, _this.authCallbacks(user, resolve, reject, customUserAgentDetails), core_1.getAmplifyUserAgent(customUserAgentDetails));
        });
    };
    /**
     ...
     */
    InternalAuthClass.prototype.getMFAOptions = function (user, customUserAgentDetails) {
        var internalUser = user;
        return new Promise(function (res, rej) {
            internalUser.getMFAOptions(function (err, mfaOptions) {
                if (err) {
                ...
                res(mfaOptions);
                return;
            }, utils_1.getAuthUserAgentValue(core_1.AuthAction.GetMFAOptions, customUserAgentDetails));
        });
    };
    /**
     ...
     * @param {CustomUserAgentDetails} customUserAgentDetails - Optional parameter to send user agent details
     */
    InternalAuthClass.prototype.getPreferredMFA = function (user, params, customUserAgentDetails) {
        var _this = this;
        var internalUser = user;
        var that = this;
        return new Promise(function (res, rej) {
            ...
            var userAgentValue = utils_1.getAuthUserAgentValue(core_1.AuthAction.GetPreferredMFA, customUserAgentDetails);
            internalUser.getUserData(function (err, data) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.cleanUpInvalidSession(user, userAgentValue)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
            ...
            }); }, { bypassCache: bypassCache, clientMetadata: clientMetadata }, userAgentValue);
        });
    };
    InternalAuthClass.prototype._getMfaTypeFromUserData = function (data) {
        var ret = null;
    ...
    InternalAuthClass.prototype._getUserData = function (user, params, userAgentValue) {
        var _this = this;
        return new Promise(function (res, rej) {
     ...
     */
    InternalAuthClass.prototype.setPreferredMFA = function (user, mfaMethod, customUserAgentDetails) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var internalUser, userAgentValue, clientMetadata, userData, smsMfaSettings, totpMfaSettings, _a, mfaList, currentMFAType, that;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        internalUser = user;
                        userAgentValue = utils_1.getAuthUserAgentValue(core_1.AuthAction.SetPreferredMFA, customUserAgentDetails);
                        clientMetadata = this._config.clientMetadata;
                    ...
                    case 7:
                        ...
                        return [2 /*return*/, new Promise(function (res, rej) {
                                internalUser.setUserMfaPreference(smsMfaSettings, totpMfaSettings, function (err, result) {
                                    if (err) {
     ...
     */
    InternalAuthClass.prototype.disableSMS = function (user, customUserAgentDetails) {
        var internalUser = user;
        return new Promise(function (res, rej) {
            internalUser.disableMFA(function (err, data) {
                if (err) {
                ...
                res(data);
                return;
            }, utils_1.getAuthUserAgentValue(core_1.AuthAction.DisableSMS, customUserAgentDetails));
        });
    };
    /**
     * enable SMS
     ...
     * @return - A promise resolves is success
     */
    InternalAuthClass.prototype.enableSMS = function (user, customUserAgentDetails) {
        var internalUser = user;
        return new Promise(function (res, rej) {
            internalUser.enableMFA(function (err, data) {
                if (err) {
                ...
                res(data);
                return;
            }, utils_1.getAuthUserAgentValue(core_1.AuthAction.EnableSMS, customUserAgentDetails));
        });
    };
    /**
     * Setup TOTP
     ...
     */
    InternalAuthClass.prototype.setupTOTP = function (user, customUserAgentDetails) {
        var internalUser = user;
        return new Promise(function (res, rej) {
            ...
            }, utils_1.getAuthUserAgentValue(core_1.AuthAction.SetupTOTP, customUserAgentDetails));
        });
    };
    /**
     * verify TOTP setup
     ...
     * @return - A promise resolves is success
     */
    InternalAuthClass.prototype.verifyTotpToken = function (user, challengeAnswer, customUserAgentDetails) {
        ...
        return new Promise(function (res, rej) {
            internalUser.verifySoftwareToken(challengeAnswer, 'My TOTP device', {
                onFailure: function (err) {
                ...
                onSuccess: function (data) {
                    if (!isLoggedIn) {
                        dispatchAuthEvent('signIn', internalUser, "A user " + internalUser.getUsername() + " has been signed in");
                    }
                    dispatchAuthEvent('verify', internalUser, "A user " + internalUser.getUsername() + " has been verified");
                    logger.debug('verifyTotpToken success', data);
                    res(data);
                    return;
                },
            }, utils_1.getAuthUserAgentValue(core_1.AuthAction.VerifyTotpToken, customUserAgentDetails));
        });
    };
    /**
     ...
     * @param {CustomUserAgentDetails} customUserAgentDetails - Optional parameter to send user agent details
     */
    InternalAuthClass.prototype.confirmSignIn = function (user, code, mfaType, clientMetadata, customUserAgentDetails) {
        var _this = this;
        if (clientMetadata === void 0) { clientMetadata = this._config.clientMetadata; }
        var internalUser = user;
        if (!code) {
        ...
        var that = this;
        var userAgentDetails = utils_1.getAuthUserAgentDetails(core_1.AuthAction.ConfirmSignIn, customUserAgentDetails);
        return new Promise(function (resolve, reject) {
            internalUser.sendMFACode(code, {
                onSuccess: function (session) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 6:
                                _a.trys.push([6, 8, , 9]);
                                return [4 /*yield*/, this._currentUserPoolUser(undefined, userAgentDetails)];
                            case 7:
                                currentUser = _a.sent();
            ...
            }, mfaType, clientMetadata, core_1.getAmplifyUserAgent(userAgentDetails));
        });
    };
    InternalAuthClass.prototype.completeNewPassword = function (user, password, requiredAttributes, clientMetadata, customUserAgentDetails) {
        var _this = this;
        ...
        var that = this;
        return new Promise(function (resolve, reject) {
            internalUser.completeNewPasswordChallenge(password, requiredAttributes, {
                onSuccess: function (session) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    var cred, e_5;
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
            ...
            }, clientMetadata, utils_1.getAuthUserAgentValue(core_1.AuthAction.CompleteNewPassword, customUserAgentDetails));
        });
    };
    /**
     ...
     *
     */
    InternalAuthClass.prototype.sendCustomChallengeAnswer = function (user, challengeResponses, clientMetadata, customUserAgentDetails) {
        var _this = this;
        if (clientMetadata === void 0) { clientMetadata = this._config.clientMetadata; }
        var internalUser = user;
        if (!this.userPool) {
        ...
        var that = this;
        var userAgentDetails = utils_1.getAuthUserAgentDetails(core_1.AuthAction.SendCustomChallengeAnswer, customUserAgentDetails);
        return new Promise(function (resolve, reject) {
            internalUser.sendCustomChallengeAnswer(challengeResponses, _this.authCallbacks(internalUser, resolve, reject, userAgentDetails), clientMetadata, core_1.getAmplifyUserAgent(userAgentDetails));
        });
    };
    /**
     ...
     * @return {Promise}
     **/
    InternalAuthClass.prototype.deleteUserAttributes = function (user, attributeNames, customUserAgentDetails) {
        var internalUser = user;
        var that = this;
        var userAgentValue = utils_1.getAuthUserAgentValue(core_1.AuthAction.DeleteUserAttributes, customUserAgentDetails);
        return new Promise(function (resolve, reject) {
            that._userSession(userAgentValue, internalUser).then(function (session) {
                internalUser.deleteAttributes(attributeNames, function (err, result) {
                    if (err) {
                        return reject(err);
                    }
                    else {
    ...
    InternalAuthClass.prototype.deleteUser = function (customUserAgentDetails) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, new Promise(function (res, rej) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var internalUser_1, userAgentValue_1;
                                var _this = this;
                                return tslib_1.__generator(this, function (_a) {
                                    if (this.userPool) {
                                        internalUser_1 = this.userPool.getCurrentUser();
                                        if (!internalUser_1) {
                                            logger.debug('Failed to get user from user pool');
                                            return [2 /*return*/, rej(new Error('No current user.'))];
                                        }
                                        else {
                                            userAgentValue_1 = utils_1.getAuthUserAgentValue(core_1.AuthAction.DeleteUser, customUserAgentDetails);
                                            internalUser_1.getSession(function (err, session) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                                var cleanUpError_4;
                                                var _this = this;
                                                return tslib_1.__generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        ...
                                                        case 1:
                                                            _a.trys.push([1, 3, , 4]);
                                                            return [4 /*yield*/, this.cleanUpInvalidSession(internalUser_1, userAgentValue_1)];
                                                        case 2:
                                                            _a.sent();
                                                            return [3 /*break*/, 4];
                                                        case 3:
                                                        ...
                                                        case 4: return [2 /*return*/, rej(err)];
                                                        case 5:
                                                            internalUser_1.deleteUser(function (err, result) {
                                                                if (err) {
                                                                    rej(err);
                                                                }
                                                                else {
                                                                    dispatchAuthEvent('userDeleted', result, 'The authenticated user has been deleted.');
                                                                    internalUser_1.signOut(undefined, userAgentValue_1);
                                                                    _this.user = null;
                                                                    try {
     ...
     * @return {Promise}
     **/
    InternalAuthClass.prototype.updateUserAttributes = function (user, attributes, clientMetadata, customUserAgentDetails) {
        var _this = this;
        if (clientMetadata === void 0) { clientMetadata = this._config.clientMetadata; }
        var internalUser = user;
        var attributeList = [];
        var that = this;
        var userAgentValue = utils_1.getAuthUserAgentValue(core_1.AuthAction.UpdateUserAttributes, customUserAgentDetails);
        return new Promise(function (resolve, reject) {
            that._userSession(userAgentValue, internalUser).then(function (session) {
                ...
                internalUser.updateAttributes(attributeList, function (err, result, details) {
                    if (err) {
                ...
                }, clientMetadata, userAgentValue);
            });
        });
    };
    InternalAuthClass.prototype.createUpdateAttributesResultList = function (attributes, codeDeliveryDetailsList) {
        var attrs = {};
     ...
     */
    InternalAuthClass.prototype.userAttributes = function (user, customUserAgentDetails) {
        return this._userAttributes(user, customUserAgentDetails);
    };
    InternalAuthClass.prototype._userAttributes = function (user, customUserAgentDetails) {
        var _this = this;
        var internalUser = user;
        var userAgentValue = utils_1.getAuthUserAgentValue(core_1.AuthAction.UserAttributes, customUserAgentDetails);
        return new Promise(function (resolve, reject) {
            _this._userSession(userAgentValue, internalUser).then(function (session) {
                internalUser.getUserAttributes(function (err, attributes) {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    InternalAuthClass.prototype.verifiedContact = function (user, customUserAgentDetails) {
        var that = this;
        return this._userAttributes(user, utils_1.getAuthUserAgentDetails(core_1.AuthAction.VerifiedContact, customUserAgentDetails)).then(function (attributes) {
    ...
    InternalAuthClass.prototype.isErrorWithMessage = function (err) {
        return (typeof err === 'object' &&
            Object.prototype.hasOwnProperty.call(err, 'message'));
    };
    // Session revoked by another app
    InternalAuthClass.prototype.isTokenRevokedError = function (err) {
        return (this.isErrorWithMessage(err) &&
            err.message === 'Access Token has been revoked');
    };
    InternalAuthClass.prototype.isRefreshTokenRevokedError = function (err) {
        return (this.isErrorWithMessage(err) &&
            err.message === 'Refresh Token has been revoked');
    };
    InternalAuthClass.prototype.isUserDisabledError = function (err) {
        return this.isErrorWithMessage(err) && err.message === 'User is disabled.';
    };
    InternalAuthClass.prototype.isUserDoesNotExistError = function (err) {
        return (this.isErrorWithMessage(err) && err.message === 'User does not exist.');
    };
    InternalAuthClass.prototype.isRefreshTokenExpiredError = function (err) {
        return (this.isErrorWithMessage(err) &&
            err.message === 'Refresh Token has expired');
    };
    InternalAuthClass.prototype.isPasswordResetRequiredError = function (err) {
        return (this.isErrorWithMessage(err) &&
            err.message === 'Password reset required for the user');
    };
    InternalAuthClass.prototype.isSignedInHostedUI = function () {
        return (this._oAuthHandler &&
            this._storage.getItem('amplify-signin-with-hostedUI') === 'true');
    };
    InternalAuthClass.prototype.isSessionInvalid = function (err) {
    ...
    InternalAuthClass.prototype.cleanUpInvalidSession = function (internalUser, userAgentValue) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var e_7;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
     ...
     */
    InternalAuthClass.prototype.currentUserPoolUser = function (params, customUserAgentDetails) {
        return this._currentUserPoolUser(params, customUserAgentDetails);
    };
    InternalAuthClass.prototype._currentUserPoolUser = function (params, customUserAgentDetails) {
        var _this = this;
        if (!this.userPool) {
            return this.rejectNoUserPool();
        }
        return new Promise(function (res, rej) {
            _this._storageSync
                ...
                var internalUser, userAgentValue_2, session, bypassCache, clientMetadata, _a, scope, err_1;
                var _this = this;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            _b.label = 2;
                        case 2:
                            internalUser = this.userPool.getCurrentUser();
                            if (!internalUser) {
                                logger.debug('Failed to get user from user pool');
                                rej('No current user');
                                return [2 /*return*/];
                        ...
                        case 3:
                            _b.trys.push([3, 7, , 8]);
                            userAgentValue_2 = utils_1.getAuthUserAgentValue(core_1.AuthAction.CurrentUserPoolUser, customUserAgentDetails);
                            return [4 /*yield*/, this._userSession(userAgentValue_2, internalUser)];
                        case 4:
                            session = _b.sent();
                                ...
                                internalUser.getUserData(function (err, data) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                _a.trys.push([1, 3, , 4]);
                                                return [4 /*yield*/, this.cleanUpInvalidSession(internalUser, userAgentValue_2)];
                                            case 2:
                                                _a.sent();
                                                return [3 /*break*/, 4];
                                            case 3:
                                            ...
                                            case 7:
                                                ...
                                                Object.assign(internalUser, { attributes: attributes, preferredMFA: preferredMFA });
                                                return [2 /*return*/, res(internalUser)];
                                        }
                                    });
                                }); }, { bypassCache: bypassCache, clientMetadata: clientMetadata }, userAgentValue_2);
                            }
                            else {
    ...
    InternalAuthClass.prototype.isOAuthInProgress = function () {
     ...
     * @return - A promise resolves to current authenticated CognitoUser if success
     */
    InternalAuthClass.prototype.currentAuthenticatedUser = function (params, customUserAgentDetails) {
        return this._currentAuthenticatedUser(params, customUserAgentDetails);
    };
    InternalAuthClass.prototype._currentAuthenticatedUser = function (params, customUserAgentDetails) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        _a.trys.push([6, 8, , 9]);
                        return [4 /*yield*/, this._currentUserPoolUser(params, utils_1.getAuthUserAgentDetails(core_1.AuthAction.CurrentAuthenticatedUser, customUserAgentDetails))];
                    case 7:
                        user = _a.sent();
                        return [3 /*break*/, 9];
                    case 8:
     ...
     */
    InternalAuthClass.prototype.currentSession = function (customUserAgentDetails) {
        return this._currentSession(customUserAgentDetails);
    };
    InternalAuthClass.prototype._currentSession = function (customUserAgentDetails) {
        var that = this;
        var userAgentDetails = utils_1.getAuthUserAgentDetails(core_1.AuthAction.CurrentSession, customUserAgentDetails);
        ...
        return new Promise(function (res, rej) {
            that
                ...
                .then(function (user) {
                that
                    ._userSession(core_1.getAmplifyUserAgent(userAgentDetails), user)
    ...
    InternalAuthClass.prototype._userSession = function (userAgentValue, internalUser) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
                    ...
                    case 0:
                        ...
                        if (this.inflightSessionPromiseCounter === 0) {
                            this.inflightSessionPromise = new Promise(function (res, rej) {
                                internalUser.getSession(function (err, session) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                    var cleanUpError_6;
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                if (!err) return [3 /*break*/, 5];
                                                logger.debug('Failed to get the session from user', internalUser);
                                                if (!this.isSessionInvalid(err)) return [3 /*break*/, 4];
                                                _a.label = 1;
                                            case 1:
                                                _a.trys.push([1, 3, , 4]);
                                                return [4 /*yield*/, this.cleanUpInvalidSession(internalUser, userAgentValue)];
                                            case 2:
                                                _a.sent();
                                                return [3 /*break*/, 4];
                                            case 3:
                                ...
                                }); }, { clientMetadata: clientMetadata }, userAgentValue);
                            });
                        }
     ...
     */
    InternalAuthClass.prototype.userSession = function (user, customUserAgentDetails) {
        return this._userSession(utils_1.getAuthUserAgentValue(core_1.AuthAction.UserSession, customUserAgentDetails), user);
    };
    /**
     ...
     */
    InternalAuthClass.prototype.currentUserCredentials = function (customUserAgentDetails) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (federatedInfo) {
                            ...
                            return [2 /*return*/, this._currentSession(utils_1.getAuthUserAgentDetails(core_1.AuthAction.CurrentUserCredentials, customUserAgentDetails))
                                    .then(function (session) {
    ...
    InternalAuthClass.prototype.currentCredentials = function (customUserAgentDetails) {
     ...
     */
    InternalAuthClass.prototype.verifyUserAttribute = function (user, attr, clientMetadata, customUserAgentDetails) {
        if (clientMetadata === void 0) { clientMetadata = this._config.clientMetadata; }
        return this._verifyUserAttribute(user, attr, clientMetadata, customUserAgentDetails);
    };
    InternalAuthClass.prototype._verifyUserAttribute = function (user, attr, clientMetadata, customUserAgentDetails) {
        if (clientMetadata === void 0) { clientMetadata = this._config.clientMetadata; }
        var internalUser = user;
        return new Promise(function (resolve, reject) {
            internalUser.getAttributeVerificationCode(attr, {
            ...
            }, clientMetadata, utils_1.getAuthUserAgentValue(core_1.AuthAction.VerifyUserAttribute, customUserAgentDetails));
        });
    };
    /**
     ...
     * @return - A promise resolves to callback data if success
     */
    InternalAuthClass.prototype.verifyUserAttributeSubmit = function (user, attr, code, customUserAgentDetails) {
        return this._verifyUserAttributeSubmit(user, attr, code, customUserAgentDetails);
    };
    InternalAuthClass.prototype._verifyUserAttributeSubmit = function (user, attr, code, customUserAgentDetails) {
        if (!code) {
            return this.rejectAuthError(Auth_1.AuthErrorTypes.EmptyCode);
        }
        var internalUser = user;
        return new Promise(function (resolve, reject) {
            internalUser.verifyAttribute(attr, code, {
                onSuccess: function (data) {
                    resolve(data);
                    return;
                },
            ...
            }, utils_1.getAuthUserAgentValue(core_1.AuthAction.VerifyUserAttributeSubmit, customUserAgentDetails));
        });
    };
    InternalAuthClass.prototype.verifyCurrentUserAttribute = function (attr, customUserAgentDetails) {
        var userAgentDetails = utils_1.getAuthUserAgentDetails(core_1.AuthAction.VerifyCurrentUserAttribute, customUserAgentDetails);
        var that = this;
        return that
            ._currentUserPoolUser(undefined, userAgentDetails)
            .then(function (user) {
            return that._verifyUserAttribute(user, attr, undefined, userAgentDetails);
        });
    };
    /**
     ...
     * @return - A promise resolves to callback data if success
     */
    InternalAuthClass.prototype.verifyCurrentUserAttributeSubmit = function (attr, code, customUserAgentDetails) {
        var userAgentDetails = utils_1.getAuthUserAgentDetails(core_1.AuthAction.VerifyCurrentUserAttributeSubmit, customUserAgentDetails);
        var that = this;
        return that
            ._currentUserPoolUser(undefined, userAgentDetails)
            .then(function (user) {
            return that._verifyUserAttributeSubmit(user, attr, code, userAgentDetails);
        });
    };
    InternalAuthClass.prototype.cognitoIdentitySignOut = function (opts, internalUser, userAgentValue) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, new Promise(function (res, rej) {
                                if (opts && opts.global) {
                                    ...
                                    var clientMetadata = _this._config.clientMetadata; // TODO: verify behavior if this is override during signIn
                                    internalUser.getSession(function (err, result) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                        var cleanUpError_7;
                                        var _this = this;
                                        return tslib_1.__generator(this, function (_a) {
                                            switch (_a.label) {
    ...
    InternalAuthClass.prototype.oAuthSignOutRedirect = function (resolve, reject) {
    ...
    InternalAuthClass.prototype.oAuthSignOutAndResolve = function (resolve) {
        this._oAuthHandler.signOut();
        resolve();
    };
    InternalAuthClass.prototype.oAuthSignOutRedirectOrReject = function (reject) {
     ...
     */
    InternalAuthClass.prototype.signOut = function (opts, customUserAgentDetails) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var e_12, internalUser;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 3:
                        ...
                        internalUser = this.userPool.getCurrentUser();
                        if (!internalUser) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.cognitoIdentitySignOut(opts, internalUser, utils_1.getAuthUserAgentValue(core_1.AuthAction.SignOut, customUserAgentDetails))];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
    ...
    InternalAuthClass.prototype.cleanCachedItems = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
     ...
     */
    InternalAuthClass.prototype.changePassword = function (user, oldPassword, newPassword, clientMetadata, customUserAgentDetails) {
        var _this = this;
        if (clientMetadata === void 0) { clientMetadata = this._config.clientMetadata; }
        var internalUser = user;
        var userAgentValue = utils_1.getAuthUserAgentValue(core_1.AuthAction.ChangePassword, customUserAgentDetails);
        return new Promise(function (resolve, reject) {
            _this._userSession(userAgentValue, internalUser).then(function (session) {
                internalUser.changePassword(oldPassword, newPassword, function (err, data) {
                    if (err) {
     ...
     * @return - A promise resolves if success
     */
    InternalAuthClass.prototype.forgotPassword = function (username, clientMetadata, customUserAgentDetails) {
        if (clientMetadata === void 0) { clientMetadata = this._config.clientMetadata; }
        if (!this.userPool) {
            return this.rejectNoUserPool();
        }
        ...
        var internalUser = this.createCognitoUser(username);
        return new Promise(function (resolve, reject) {
            internalUser.forgotPassword({
                ...
                inputVerificationCode: function (data) {
                    dispatchAuthEvent('forgotPassword', internalUser, username + " has initiated forgot password flow");
                    resolve(data);
                    return;
                },
            }, clientMetadata, utils_1.getAuthUserAgentValue(core_1.AuthAction.ForgotPassword, customUserAgentDetails));
        });
    };
    /**
     ...
     */
    InternalAuthClass.prototype.forgotPasswordSubmit = function (username, code, password, clientMetadata, customUserAgentDetails) {
        if (clientMetadata === void 0) { clientMetadata = this._config.clientMetadata; }
        if (!this.userPool) {
            return this.rejectNoUserPool();
        }
        ...
        var internalUser = this.createCognitoUser(username);
        return new Promise(function (resolve, reject) {
            internalUser.confirmPassword(code, password, {
                onSuccess: function (success) {
                    dispatchAuthEvent('forgotPasswordSubmit', internalUser, username + " forgotPasswordSubmit successful");
                    resolve(success);
                    return;
                },
                onFailure: function (err) {
            ...
            }, clientMetadata, utils_1.getAuthUserAgentValue(core_1.AuthAction.ForgotPasswordSubmit, customUserAgentDetails));
        });
    };
    /**
     ...
     */
    InternalAuthClass.prototype.currentUserInfo = function (customUserAgentDetails) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var source, userAgentDetails, internalUser, attributes, userAttrs, credentials, e_13, info, err_2, user;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        source = this.Credentials.getCredSource();
                        userAgentDetails = utils_1.getAuthUserAgentDetails(core_1.AuthAction.CurrentUserInfo, customUserAgentDetails);
                        if (!(!source || source === 'aws' || source === 'userPool')) return [3 /*break*/, 9];
                        return [4 /*yield*/, this._currentUserPoolUser(undefined, userAgentDetails).catch(function (err) { return logger.error(err); })];
                    case 1:
                        internalUser = _a.sent();
                        if (!internalUser) {
                    ...
                    case 2:
                        _a.trys.push([2, 8, , 9]);
                        return [4 /*yield*/, this._userAttributes(internalUser, userAgentDetails)];
                    case 3:
                        attributes = _a.sent();
    ...
    InternalAuthClass.prototype.federatedSignIn = function (providerOrOptions, response, user, customUserAgentDetails) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (this._config.userPoolId) {
                            ...
                            this._storage.setItem('aws-amplify-federatedUserAgent', utils_1.getAuthUserAgentValue(core_1.AuthAction.FederatedSignIn, customUserAgentDetails));
                    ...
                    case 2:
                        credentials = _a.sent();
                        return [4 /*yield*/, this._currentAuthenticatedUser()];
                    case 3:
                        currentUser = _a.sent();
     ...
     */
    InternalAuthClass.prototype._handleAuthResponse = function (URL) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var currentUrl, hasCodeOrError, hasTokenOrError, userAgentValue, _a, accessToken, idToken, refreshToken, state, session, credentials, isCustomStateIncluded, currentUser, customState, err_3;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        userAgentValue = this._storage.getItem('aws-amplify-federatedUserAgent') || undefined;
                        this._storage.removeItem('aws-amplify-federatedUserAgent');
                        _b.label = 2;
                    case 2:
                        _b.trys.push([2, 6, , 7]);
                        return [4 /*yield*/, this._oAuthHandler.handleAuthResponse(currentUrl, userAgentValue)];
                    case 3:
     ...
     */
    InternalAuthClass.prototype.essentialCredentials = function (credentials) {
        return {
    ...
    InternalAuthClass.prototype.attributesToObject = function (attributes) {
        var _this = this;
        var obj = {};
        if (attributes) {
    ...
    InternalAuthClass.prototype.isTruthyString = function (value) {
        return (typeof value.toLowerCase === 'function' && value.toLowerCase() === 'true');
    };
    InternalAuthClass.prototype.createCognitoUser = function (username) {
        var userData = {
            Username: username,
            Pool: this.userPool,
        };
        ...
        var internalUser = new internals_1.InternalCognitoUser(userData);
        if (authenticationFlowType) {
            internalUser.setAuthenticationFlowType(authenticationFlowType);
        }
        return internalUser;
    };
    InternalAuthClass.prototype._isValidAuthStorage = function (obj) {
    ...
    InternalAuthClass.prototype.noUserPoolErrorHandler = function (config) {
        if (config) {
    ...
    InternalAuthClass.prototype.rejectAuthError = function (type) {
        return Promise.reject(new Errors_1.AuthError(type));
    };
    InternalAuthClass.prototype.rejectNoUserPool = function () {
        var type = this.noUserPoolErrorHandler(this._config);
        return Promise.reject(new Errors_1.NoUserPoolError(type));
    };
    InternalAuthClass.prototype.rememberDevice = function (customUserAgentDetails) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var internalUser, userAgentDetails, error_2;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userAgentDetails = utils_1.getAuthUserAgentDetails(core_1.AuthAction.RememberDevice, customUserAgentDetails);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._currentUserPoolUser(undefined, userAgentDetails)];
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, new Promise(function (res, rej) {
                                ...
                                }, core_1.getAmplifyUserAgent(userAgentDetails));
                            })];
                }
            });
        });
    };
    InternalAuthClass.prototype.forgetDevice = function (customUserAgentDetails) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var internalUser, userAgentDetails, error_3;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userAgentDetails = utils_1.getAuthUserAgentDetails(core_1.AuthAction.ForgetDevice, customUserAgentDetails);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._currentUserPoolUser(undefined, userAgentDetails)];
    ...
    InternalAuthClass.prototype.fetchDevices = function (customUserAgentDetails) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var internalUser, userAgentDetails, error_4;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userAgentDetails = utils_1.getAuthUserAgentDetails(core_1.AuthAction.FetchDevices, customUserAgentDetails);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._currentUserPoolUser(undefined, userAgentDetails)];
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, new Promise(function (res, rej) {
                                ...
                                internalUser.listDevices(MAX_DEVICES, null, cb, core_1.getAmplifyUserAgent(userAgentDetails));
                            })];
                }
            });
        });
    };
    return InternalAuthClass;
}());
exports.InternalAuthClass = InternalAuthClass;
exports.InternalAuth = new InternalAuthClass(null);
core_1.Amplify.register(exports.InternalAuth);
