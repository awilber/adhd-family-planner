...
var AWSAppSyncRealTimeProvider = /** @class */ (function (_super) {
    ...
    AWSAppSyncRealTimeProvider.prototype._awsRealTimeCUPHeader = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, InternalAuth.currentSession(customUserAgentDetails)];
                    case 1:
                        session = _b.sent();
                        return [2 /*return*/, {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, InternalAuth.currentAuthenticatedUser(undefined, customUserAgentDetails)];
                    case 3:
                        currentUser = _b.sent();
                        if (currentUser) {
