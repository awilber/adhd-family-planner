...
var internals_1 = require("@aws-amplify/auth/internals");
...
var AWSAppSyncRealTimeProvider = /** @class */ (function (_super) {
    ...
    AWSAppSyncRealTimeProvider.prototype._awsRealTimeHeaderBasedAuth = function (_a) {
        var authenticationType = _a.authenticationType, payload = _a.payload, canonicalUri = _a.canonicalUri, appSyncGraphqlEndpoint = _a.appSyncGraphqlEndpoint, apiKey = _a.apiKey, region = _a.region, additionalHeaders = _a.additionalHeaders, customUserAgentDetails = _a.customUserAgentDetails;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    AWSAppSyncRealTimeProvider.prototype._awsRealTimeCUPHeader = function (_a) {
        var host = _a.host, customUserAgentDetails = _a.customUserAgentDetails;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var session;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, internals_1.InternalAuth.currentSession(customUserAgentDetails)];
                    case 1:
                        session = _b.sent();
                        return [2 /*return*/, {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, internals_1.InternalAuth.currentAuthenticatedUser(undefined, customUserAgentDetails)];
                    case 3:
                        currentUser = _b.sent();
                        if (currentUser) {
